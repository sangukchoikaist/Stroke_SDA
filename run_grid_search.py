...
def run_grid_search_parallel():
    ...
    results_base_dir = "d:/RSC lab/Codes/Stroke_SDA/results_grid_search"
    ...
    # Execute Parallel
    num_workers = 3 # Conservative default for 3090 (24GB). Each job < 2GB VRAM? 
                    # SDA model is tiny. Data loading takes RAM. 
                    # 4-6 workers should be fine. 
                    # Let's try 4. 
    max_workers = 4 
