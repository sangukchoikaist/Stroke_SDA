...
CONFIG = {
    ...
    'lambda_mmd': 2.0,     # Rank 3 Best
    'lambda_src': 0.7,     # Rank 3 Best
    'lambda_tgt': 1.0,    
    'input_dim': 8,
    'hidden_dim': 64,
    'encoder_layers': [256, 128], # Rank 3
    'decoder_layers': [64],      # Rank 3
    ...
    for subj in subjects:
        ...
        for mode in modes:
            ...
            for i, test_trial in enumerate(target_trials):
                ...
                try:
                    train_and_evaluate(i+1, train_trials, test_trial, src_data, src_labels, mode=mode, normalization='independent')
